...
It uses the [Frankfurter API](https://www.frankfurter.dev/) — no sign-up or key required. Data is sourced from the European Central Bank and updated daily.
...
## Open Source
Feel free to clone, use, and edit this code however you want.
